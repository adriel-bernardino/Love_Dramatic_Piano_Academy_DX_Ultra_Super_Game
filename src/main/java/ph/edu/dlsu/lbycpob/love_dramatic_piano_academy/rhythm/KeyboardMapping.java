...
public class KeyboardMapping {
    ...
    public KeyboardMapping(){
        ...
        keyMap.put(KeyCode.J,List.of("B4"));
        keyMap.put(KeyCode.K,List.of("C5"));
        keyMap.put(KeyCode.L,List.of("D5"));
        keyMap.put(KeyCode.SEMICOLON,List.of("F5"));
        keyMap.put(KeyCode.W,List.of("C#4"));
        keyMap.put(KeyCode.E,List.of("D#4"));
        keyMap.put(KeyCode.T,List.of("F#3","F#4"));
        keyMap.put(KeyCode.Y,List.of("G#3","G#4"));
        keyMap.put(KeyCode.U,List.of("A#4"));
        keyMap.put(KeyCode.O,List.of("C#5"));
        keyMap.put(KeyCode.P,List.of("D#5"));
    }

    public boolean matches(KeyCode key,String targetNote){
        List<String> notes = keyMap.get(key);
        return notes != null && notes.contains(targetNote);
    }
}
